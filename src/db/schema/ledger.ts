...
export const transactions = pgTable(
  ...
  (t) => ({
    ...
    storeFk: foreignKey({
      columns: [t.companyId, t.storeId],
      foreignColumns: [stores.companyId, stores.id],
    }),
    dateIdx: index('transactions_company_date_idx').on(t.companyId, t.date),
    typeCatIdx: index('transactions_company_type_cat_date_idx').on(
      t.companyId,
      t.type,
      t.category,
      t.date,
...
export const invoices = pgTable(
  ...
  (t) => ({
    ...
    settledFk: foreignKey({
      columns: [t.companyId, t.settledTransactionId],
      foreignColumns: [transactions.companyId, transactions.id],
    }),
