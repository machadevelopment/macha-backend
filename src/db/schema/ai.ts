...
export const aiUsageEvents = pgTable('ai_usage_events', {
  ...
  kind: text('kind').$type<'excel' | 'chat' | 'insight' | 'report_generation' | 'excel_correction'>().notNull(),
  refId: uuid('ref_id'),
...
export const creditTransactions = pgTable('credit_transactions', {
  ...
  reason: text('reason').$type<'monthly_allotment' | 'top_up' | 'insight_consumption'>().notNull(),
